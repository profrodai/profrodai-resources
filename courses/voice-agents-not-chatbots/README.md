...
Source: [`profrod-site/content/courses/voice-agents-not-chatbots/_course.md`](https://github.com/rodriveracom/profrod-site/tree/main/content/courses/voice-agents-not-chatbots). This is a
